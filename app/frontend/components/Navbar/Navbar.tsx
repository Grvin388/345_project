    ...
    <nav className={styles.navWrapper}>
      <div className={styles.navContainer}>
        ...
        <div className={styles.navLinks}>
          <Link href="/" className={styles.navLink}>Browse Events</Link>
          <Link href="/reservations" className={styles.navLink}>My Tickets</Link>
          ...
          {loading ? (
            ...
            <div className="flex items-center gap-4">
              <div className={styles.userProfile}>
                {user.photoURL ? (
                  <img src={user.photoURL} alt="Profile" className={styles.userAvatar} />
                ) : (
